                        ...
                        <div
                            ...
                            <ul class="flex flex-col gap-4 py-2 ml-2 mr-8 text-lg">
                                    ...
                                    <div
                                        ...
                                        <div
                                            ...
                                            <div class="grid grid-cols-2 gap-5 px-5 py-3">
                                                <div class="flex flex-col gap-4">
                                                    ...
                                                    <label for="live_thumbnail"
                                                        ...
                                                        ảnh</label>
                                                    <input type="file" v-on:change="attachThumbnail($event)" id="live_thumbnail" class="hidden">
                                                </div>
                                                <div class="flex flex-col gap-4">
                                                    ...
                                                    <div class="flex flex-col gap-2">
                                                        ...
                                                        <input
                                                            ...
                                                            type="datetime-local" v-model="start_time" id="modal_live_date">
                                                    </div>
                                            ...
                                            <h1 class="w-full px-5 py-4 text-xl font-medium text-center text-red-500">
                                                click vào <span class="txt-auth" v-on:click="callAuthGoogleLive()">đây</span> để cập nhật lại token!</h1>
                                        </div>
                                    </div>
                                ...
                                <li>
                                    ...
                                    <label class="cursor-pointer hover:opacity-75" for="modal_info">Cập nhật thông tin</label>

            ...
            <div class="flex flex-row justify-between flex-grow h-[10%] mx-6 items-center content-center">
                <div id="author-infor" class="flex items-center gap-4">
                    ...
                    <div class="flex flex-col justify-center flex-grow text-white">
                        <div id="author-name" class="flex items-center justify-between w-full text-base font-medium">
                            <p>feyd153</p>
                        </div>
                ...
                <div class="flex gap-5 text-2xl text-white">
                        ...
                        <div
                            ...
                            <div class="flex flex-col gap-6 px-6 py-5">
                                ...
                                <div class="flex flex-col gap-4">
                                    <div class="flex flex-col gap-4">
                                        <label for="modal-report"
                                            class="text-xl font-medium text-white cursor-pointer">Mô tả vi phạm</label>
                                        <input
                    ...
                    <div
                        ...
                        <div
                            ...
                            <div class="flex flex-col gap-6 px-6 py-5">
                                <h1 class="w-full text-2xl font-bold text-center text-white">Thông tin phiên live</h1>
                                <!-- Start phiên live của tôi -->
                                <div class="flex flex-col gap-4">
                                    <div class="flex flex-col gap-2">
                                        <label for="modal-stream-infor"
                                            class="ml-2 text-xl font-medium text-white">watch_url</label>
                                        <p class="text-base px-5 py-4 bg-[#222222] rounded-xl text-gray-300" type="text"
                                            id="modal-stream-infor">watch_url</p>
                                    </div>
                                    <div class="flex flex-col gap-2">
                                        <label for="modal-stream-infor"
                                            class="ml-2 text-xl font-medium text-white">stream_url</label>
                                        <p class="text-base px-5 py-4 bg-[#222222] rounded-xl text-gray-300" type="text"
                                            id="modal-stream-infor">stream_url</p>
                                    </div>
                                    <div class="flex flex-col gap-2">
                                        <label for="modal-stream-infor"
                                            class="ml-2 text-xl font-medium text-white">stream_key</label>
                                        <p class="text-base px-5 py-4 bg-[#222222] rounded-xl text-gray-300" type="text"
                                            id="modal-stream-infor">stream_key</p>
                                    </div>
                                </div>
    ...
    export default {
        ...
        methods: {
            ...
            async callAPI() {
                try {
                    let typeData = [];
                    const callAPI = await axios.get('http://localhost/UniStreeamAPI/public/api/list-data', {
                        /************ Attach param for request here ***************/
                    }).then(function (response) {
                        // Append data to chart
                        // response la du lieu ma server tra ve
            ...
            async liveDetail() {
                try {
                    const callAPI = await axios.get('http://localhost/UniStreamAPI/public/api/live-detail', {
                        /************ Attach param for request here ***************/
                        headers: {
